...
export default function AgroFornecedoresPage() {
  const supplierListings = demoListings.filter(
    (listing) =>
      listing.module === "agro" &&
      listing.category === "insumos" &&
      listing.isActive
  );
  ...
  return (
    <main
      style={{
        minHeight: "100vh",
        background:
          "linear-gradient(180deg, #081226 0%, #101828 55%, #16301f 100%)",
        color: "#ffffff",
        padding: "24px",
      }}
    >
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            >
              Área de fornecedores pronta para vender, captar clientes e escalar
            </h1>
            ...
            >
              Esta página já usa a nova lógica de contato da Aurora, com
              WhatsApp por empresa e por anúncio, sem número fixo no código.
            </p>
          ...
          <div style={heroCard}>
            ...
            >
              Fornecedores com contato por anúncio
            </h2>
            ...
            >
              Cada oportunidade abaixo pode usar um contato diferente da empresa,
              conforme o responsável definido no anúncio.
            </p>
            ...
            <div style={statsGrid}>
              ...
              <div style={statCard}>
                ...
                <span style={statLabel}>com equipe</span>
              </div>
        ...
        <section style={sectionStyle}>
          <div style={sectionHeader}>
            <h2 style={sectionTitle}>Oportunidades para fornecedores</h2>
            <p style={sectionText}>
          ...
          <div style={cardsGrid}>
            {supplierListings.map((listing) => {
              ...
              const whatsappHref = buildListingWhatsAppUrl(
                ...
                `Olá, tenho interesse no anúncio "${listing.title}" na área de fornecedores do Aurora AGRO.`
              );
        ...
        <section style={sectionStyle}>
          ...
          <div style={cardsGrid}>
            <article style={infoCard}>
              ...
              <p style={infoText}>
                Cada fornecedor vai informar sua empresa, contatos e áreas de
                atendimento.
              </p>
            </article>
            ...
            <article style={infoCard}>
              ...
              <p style={infoText}>
                Cada anúncio poderá apontar para o vendedor ou responsável mais
                adequado.
              </p>
            </article>
