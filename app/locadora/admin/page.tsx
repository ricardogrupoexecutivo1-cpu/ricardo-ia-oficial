...
export default function LocadoraAdminPage() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!response.ok) {
        setError(
          data?.error || "Não foi possível validar sua senha agora."
        );
        return;
      }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="aurora-locadora-admin-grid"
          style={{
            display: "grid",
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Área protegida para cadastro real de locadoras, veículos,
                motoristas, parceiros, bancos, propostas e operação comercial
                em todo o Brasil.
              </p>
          ...
          >
            ...
            >
              Use a senha administrativa para liberar o acesso ao painel da
              locadora.
            </p>

            <form onSubmit={handleSubmit}>
              <label
                htmlFor="locadora-admin-password"
                style={{
                  display: "block",
                  marginBottom: 10,
                  color: "#dcecff",
