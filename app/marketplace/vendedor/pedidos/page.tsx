...
export default function MarketplaceVendedorPedidosPage() {
  ...
  function atualizarStatusPedido(pedidoId: string, novoStatus: StatusPedidoMarketplace) {
    ...
    setMensagem(`Pedido ${pedidoId} atualizado para ${textoStatus(novoStatus)} com sucesso.`)
  }
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Link href="/marketplace/vendedor" style={botaoSecundario}>
              Voltar ao vendedor
            </Link>
            <Link href="/marketplace/vendedor/produtos" style={botaoSecundario}>
              Ver produtos
            </Link>
            <Link href="/marketplace/comprador/pedidos" style={botaoSecundario}>
              Ver painel do comprador
            </Link>
          </div>

          <div style={{ display: 'grid', gap: 18 }}>
            <div>
              <div style={badge}>Aurora Marketplace • Vendedor • Pedidos</div>
              <h1
                style={{
              ...
              >
                Página isolada para o vendedor visualizar e mover os pedidos locais do Marketplace sem
                quebrar o fluxo já validado.
              </p>
            </div>
        ...
        {carregando ? (
          <section style={cardBloco}>
            <p style={paragrafoPadrao}>Carregando pedidos do vendedor...</p>
          </section>
        ) : pedidos.length === 0 ? (
          <section style={cardBloco}>
          ...
          <section style={cardBloco}>
            <div style={{ marginBottom: 18 }}>
              <h2 style={tituloSecao}>Operação do vendedor</h2>
              <p style={paragrafoPadrao}>
                Aqui ficam os registros locais já preparados no fluxo validado do Marketplace, permitindo
                ao vendedor avançar o pedido por etapas sem quebrar o histórico.
              </p>
            </div>
                ...
                >
                  ...
                  >
                    ...
                    <div style={subCard}>
                      ...
                      <div style={valorMini}>{pedido.vendedorNome || 'Não informado'}</div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    {pedido.status === 'confirmado' ? (
                      <button
                        type="button"
                        onClick={() => atualizarStatusPedido(pedido.id, 'em_separacao')}
                        style={botaoSeparacao}
                      >
...
const botaoSeparacao: React.CSSProperties = {
  border: 'none',
  borderRadius: 14,
  padding: '12px 14px',
