...
create table if not exists public.finance_company_settings (
  ...
  fiscal_document_label text,
  income_label text not null default 'Entrada',
  expense_label text not null default 'Saída',
  category_label text not null default 'Categoria',
  activity_label text not null default 'Atividade',
  cost_center_label text not null default 'Centro de custo',
  account_label text not null default 'Conta',
...
create table if not exists public.finance_entries (
  ...
  category_id uuid references public.finance_categories(id) on delete set null,
  activity_id uuid references public.finance_activities(id) on delete set null,
